<div class="bg-white p-5 rounded-lg shadow-lg w-11/12 max-w-2xl flex m-auto justify-center mt-2 mb-2">
    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data" class="w-full">
        @csrf
        
        <!--Profile picture-->
        <div class="flex flex-col w-full ">
            <x-input-label for="profile_picture" :value="__('Profile Picture')" class="mb-4" />
            <x-file-input class="mb-2 w-full p-10" />
        ...
        {{-- Role(user in our app is either a student,admin or faculty member.) --}}
        <div class="mt-4 w-full">
