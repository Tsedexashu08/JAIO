<div class="job-filter-card">
    ...
    <button class="filters">
        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            class="icon-svg" viewBox="0 0 420 420" xml:space="preserve" fill="#000000">
            ...
            <g id="SVGRepo_iconCarrier">
                <g id="XMLID_784_">
                    ...
                    <polygon id="XMLID_787_" style="fill:#3897FF;" points="200,130 200,330 115,320 115,130 "></polygon>
                    <path id="XMLID_788_" style="fill:#233145;"
                        d="M115,150v85c-23.473,0-42.5-19.027-42.5-42.5S91.527,150,115,150z"></path>
                    <path id="XMLID_789_" style="fill:#233145;"
                        d="M115,263.755l10,27.609L115,330H30c0-33.444,19.31-62.375,47.391-76.245 L115,263.755z"></path>
                    <polygon id="XMLID_790_" style="fill:#FFFFFF;"
                        points="77.391,253.755 115,291.364 125,272.559 115,253.755 "></polygon>
                    <rect id="XMLID_791_" x="230" y="100" style="fill:#BEC8D6;" width="230" height="260"></rect>
                    <rect id="XMLID_792_" x="230" y="154.7" style="fill:#6B81A1;" width="200" height="30"></rect>
                    <rect id="XMLID_793_" x="230" y="214.7" style="fill:#6B81A1;" width="200" height="30"></rect>
                    <rect id="XMLID_794_" x="230" y="274.7" style="fill:#6B81A1;" width="200" height="30"></rect>
                    <path id="XMLID_795_" style="fill:#121923;"
                        d="M115,150c23.473,0,42.5,19.027,42.5,42.5S138.473,235,115,235V150z"></path>
                    <path id="XMLID_796_" style="fill:#121923;"
                        d="M200,330h-85v-38.636l37.609-37.609C180.69,267.625,200,296.556,200,330z"></path>
    ...
    <button class="filters">
        <svg width="97px" height="97px" viewBox="0 0 24 24" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
            class="icon-svg" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:cc="http://creativecommons.org/ns#"
            ...
            <g id="SVGRepo_iconCarrier">
                <g transform="translate(0 -1028.4)">
                    ...
                    <path
                        ...
                        transform="translate(0 1028.4)" fill="#c0392b"></path>
                    <path d="m21 1048.4-5 1v-17l5-1z" fill="#27ae60"></path>
                    <path d="m5.6875 1031.8-2.3125 0.5 4.625 4.9v-2.9l-2.3125-2.5z" fill="#f39c12"></path>
                    ...
                    <path d="m8 8.8008v-2.8985l4 8.6597h-1.469z" transform="translate(0 1028.4)" fill="#f1c40f"></path>
                    <path
...
<style>
    .job-filter-card {
        ...
        height:60px;
        background: #fff;
        box-shadow: rgba(0, 0, 0, .2) 2px 2px 4px, rgba(0, 0, 0, .1) 0 7px 13px -2px, rgba(0, 0, 0, .2) 0 0 0 inset;
        margin: 0 auto;
        /* position: relative; */
        /* top: 20%; */
